...
<body>
	...
	<div id="addDialog" class="easyui-dialog" title="修改  " style="width:400px;height:400px;"  data-options="iconCls:'icon-save',resizable:true,modal:true,closed:true">
		<form id="addForm" method="post">   
			<table>
			    ...
			    <tr>
			        ...
			        <td>
			        	<select class="easyui-combobox" style="width:100px;" id="updates_askerId" name="s_askerId">   
						    <option value="">--请选择--</option>      
			    ...
			    <tr>
			        ...
			        <td><input class="easyui-textbox" type="text" id="updates_isReport" name="s_isReport"/></td>
			    </tr>
			    <tr>
			        <td><label>在线备注：</label></td>
			        <td><input class="easyui-textbox" type="text" id="updates_remarks" name="s_remarks"/></td>
			    </tr>
